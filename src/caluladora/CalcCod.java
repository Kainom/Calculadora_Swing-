...
// * @author User
// */
//public class CalcCod extends JFrame implements ActionListener {
//
//    private String n0, n1, n2, n3, n4, n5, n6, n7, n8, n9, memoria = "", tela = "";
//    private int resultado, verifica = -1, verficaOperation = 0, verifica2 = 1;
//
//    public JLabel lbl2 = new JLabel("0");
//    public JButton bnt0;
//    public JButton bnt;
//    public JButton bnt1;
//    public JButton bnt2;
...
//
//                int j = 0;
//                char memori[] = this.getMemoria().toCharArray();
//                int tam = memori.length;
//                int conta[] = new int[tam];
...
//                }
//
//                numeros = memori.toString();
//                numeros = numeros.replace("*", "");
//                numeros = numeros.replace("+", "");
//                conta[tam] = Integer.parseInt(numeros);
//
